 ...
 */
WudoFlyout.prototype.findOpenTrigger = function (triggers, el) {
 ...
 */
WudoFlyout.prototype.clickEvent = function (e) {
  e.stopPropagation();
 ...
 */
WudoFlyout.prototype.closeAllTriggerClickEvent = function (e) {
  e.stopPropagation();
  if (e.target.hasAttribute('data-flyout-trigger-allow-default') !== true) {
    e.preventDefault();
  }
 ...
 * Expand flyout.
 */
WudoFlyout.prototype.expand = function () {
  ...
  // document.body.style.overflow = 'hidden'; // Optional: prevent body scroll when flyout is open.
 ...
 * Collapse flyout.
 */
WudoFlyout.prototype.collapse = function () {
